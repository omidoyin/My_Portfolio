    ...
    <section className="experience">
      ...
      >
        <VerticalTimelineElement
          ...
          icon={<WorkIcon />}
        >
          <h3 className="vertical-timeline-element-title">{work.work1.title}</h3>
          <h4 className="vertical-timeline-element-subtitle">{work.work1.subtitle}</h4>
          <p>
          {work.work1.description}
          </p>
        </VerticalTimelineElement>
        ...
        <VerticalTimelineElement
          ...
          icon={<WorkIcon />}
        >
          <h3 className="vertical-timeline-element-title">{work.work2.title}</h3>
          <h4 className="vertical-timeline-element-subtitle">
          {work.work2.subtitle}
          </h4>
          <p>
          {work.work2.description}
          </p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">{education.education1.subtitle}</h4>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">{education.education2.subtitle}</h4>
